...
const Header = ({setShow}) => {
  ...
  return (
      <div className='flex flex-row border-solid border-b border-b-white py-5'>
        <div className='text-left w-1/2'>
          <Link to={"/"}>
            <img src={location.pathname == '/about' || location.pathname == '/service' ? white : logo} alt="logo" className='object-scale-down' width={200}/>
          </Link>
        </div>
        <div className='w-1/2'>
          <div className="flex flex-row justify-center gap-x-10 ">
            ...
            <Link to={"/getintouch"}className='text-white font-gotham-book cursor-pointer'>Get In Touch</Link>
