...
const QualityLanding = () => {
    return (
        ...
        <div className='flex flex-col space-y-4'>
            ...
            <p className='font-poppin-thin font-bold font-thin text-sm md:lg'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum sagittis dictum mattis. Phasellus sodales nec leo nec accumsan. Morbi fermentum nulla in leo consequat, at ultricies ante sollicitudin.</p>
